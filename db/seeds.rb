...
post1 = Post.create(title: "Landscaper", address: "Newcastle", content: "", category: "Outdoor")
...
post1.user = user1
post1.save!
post2 = Post.create(title: "Trader", address: "Amsterdam", content: "", category: "Finance")
...
post2.user = user1
post2.save!
post3 = Post.create(title: "Food Truck Owner", address: "Edinburgh", content: "", category: "Hospitality")
...
post3.user = user1
post3.save!
post4 = Post.create(title: "Freelance Artist", address: "Lisbon", content: "", category: "The Arts")
...
post4.user = user1
post4.save!
post5 = Post.create(title: "Clothing Entrepeneur", address: "London", content: "", category: "Business")
...
post5.user = user2
post5.save!
post6 = Post.create(title: "Yacht Chef", address: "Monaco", content: "", category: "Hospitality")
...
post6.user = user2
post6.save!
post7 = Post.create(title: "Helicopter Pilot", address: "Aberdeen", content: "", category: "Trade")
...
post7.user = user2
post7.save!
post8 = Post.create(title: "House Wife", address: "Falmouth", content: "", category: "Traditional")
