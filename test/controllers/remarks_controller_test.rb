...
class RemarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create remark" do
    assert_difference("Remark.count") do
      post remarks_url, params: { remark: { content: @remark.content, post_id: @remark.post_id, title: @remark.title, user_id: @remark.user_id } }
    end
  ...
  test "should update remark" do
    patch remark_url(@remark), params: { remark: { content: @remark.content, post_id: @remark.post_id, title: @remark.title, user_id: @remark.user_id } }
